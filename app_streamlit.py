...
st.set_page_config(
    ...
    layout="wide"   # 'wide' for side-by-side columns
)
...
with tab1:
    ...
    if st.button("Predict", key="predict_main"):
        ...
        if price_input < 500:
            ...
            # Convert 'city' to dummies & align columns for 1-yr model
...
with tab2:
    ...
    st.write("This is the snippet of the Processed data!")

    if st.button("Show Sample Data", key="show_sample_data"):
        colA, colB, colC = st.columns([1, 2, 1])
        with colB:
            st.image("Images/Processed_data_snippet.png", use_column_width=True)
...
with tab3:
    ...
    st.write("**Objective**: Provide 1-year and 2-year land price forecasts based on current land price, location, etc.")
    ...
    st.write(
        ...
        "These models incorporate features such as **current price**, **month**, **year**, **city** (one-hot encoded), etc. "
    ...
    st.info("For further suggestions or collaboration, feel free to reach out at kumar2pranav@gmail.com.")
